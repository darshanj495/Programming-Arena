...
export default function GlobalChat() {
  ...
  return (
    /*
     * Floating window — pinned bottom-right.
     * Slides up & fades in on mount via windowVariants.
     */
    <motion.div
      ...
      style={{
        ...
        borderRadius: '1rem',
        overflow: 'hidden',
        /* Deep shadow so it floats off any background */
        boxShadow:
          '0 0 0 1px #1e1e2e, 0 8px 32px rgba(0,0,0,0.72), 0 0 80px rgba(16,185,129,0.05)',
        background: '#111118',
        border: '1px solid #1e1e2e',
        /* Subtle glassmorphism — only meaningful when backdrop-filter is supported */
    ...
    >
      ...
      <div
        style={{
          ...
          scrollbarWidth: 'thin',
          scrollbarColor: '#2d2d45 transparent',
        }}
      >
